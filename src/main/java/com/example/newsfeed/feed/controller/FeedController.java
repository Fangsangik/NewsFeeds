...
public class FeedController {
    ...
    @PostMapping
    public ResponseEntity<CommonResponse<FeedResponseDto>> createFeed (@RequestBody FeedRequestDto feedRequestDto) {
    ...
    // 회원 기반 피드 조회
    @GetMapping
    public ResponseEntity<CommonResponse<List<FeedResponseDto>>> getFeedsByMemberId() {
        Long memberId = AuthenticatedMemberUtil.getAuthenticatedMemberId();
    ...
    @PatchMapping("/{feedId}")
    public ResponseEntity<CommonResponse<FeedUpdateResponseDto>> updateFeed(@PathVariable Long feedId,
    ...
    public ResponseEntity<CommonResponse<Void>> deleteFeed (@PathVariable Long feedId) {
